 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new FirestoreError(e_.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,i,s={}){let o=new __PRIVATE_Deferred;return e.asyncQueue.enqueueAndForget(async()=>(function(e,i,s,o,l){let h=new __PRIVATE_AsyncObserver({next:s=>{h.eu(),i.enqueueAndForget(()=>__PRIVATE_eventManagerUnlisten(e,d)),s.fromCache&&"server"===o.source?l.reject(new FirestoreError(e_.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):l.resolve(s)},error:e=>l.reject(e)}),d=new __PRIVATE_QueryListener(s,h,{includeMetadataChanges:!0,ua:!0});return __PRIVATE_eventManagerListen(e,d)})(await __PRIVATE_getEventManager(e),e.asyncQueue,i,s,o)),o.promise})(s,e._query).then(s=>new QuerySnapshot(i,o,e,s)))}function setDoc(e,i,s){var o,l;e=__PRIVATE_cast(e,DocumentReference);let h=__PRIVATE_cast(e.firestore,Firestore),d=(o=e.converter)?s&&(s.merge||s.mergeFields)?o.toFirestore(i,s):o.toFirestore(i):i;return l=[(function(e,i,s,o,l,h={}){let d,f;let _=e.$u(h.merge||h.mergeFields?2:0,i,s,l);__PRIVATE_validatePlainObject("Data must be an object, but it was:",_,o);let g=__PRIVATE_parseObject(o,_);if(h.merge)d=new FieldMask(_.fieldMask),f=_.fieldTransforms;else if(h.mergeFields){let e=[];for(let o of h.mergeFields){let l=function(e,i,s){if((i=(0,en.m9)(i))instanceof FieldPath)return i._internalPath;if("string"==typeof i)return __PRIVATE_fieldPathFromDotSeparatedString(e,i);throw __PRIVATE_createError("Field path arguments must be of type string or ",e,!1,void 0,s)}(i,o,s);if(!_.contains(l))throw new FirestoreError(e_.INVALID_ARGUMENT,`Field '${l}' is specified in your field mask but missing from your input data.`);(function(e,i){return e.some(e=>e.isEqual(i))})(e,l)||e.push(l)}d=new FieldMask(e),f=_.fieldTransforms.filter(e=>d.covers(e.field))}else d=null,f=_.fieldTransforms;return new ParsedSetData(new ObjectValue(g),d,f)})(__PRIVATE_newUserDataReader(h),"setDoc",e._key,d,null!==e.converter,s).toMutation(e._key,Precondition.none())],function(e,i){let s=new __PRIVATE_Deferred;return e.asyncQueue.enqueueAndForget(async()=>__PRIVATE_syncEngineWrite(await __PRIVATE_ensureOnlineComponents(e).then(e=>e.syncEngine),i,s)),s.promise}(ensureFirestoreConfigured(h),l)}new WeakMap,function(e=!0){eh=ee.Jn,(0,ee.Xd)(new et.wA("firestore",(i,{instanceIdentifier:s,options:o})=>{let l=i.getProvider("app").getImmediate(),h=new Firestore(new __PRIVATE_FirebaseAuthCredentialsProvider(i.getProvider("auth-internal")),new __PRIVATE_FirebaseAppCheckTokenProvider(i.getProvider("app-check-internal")),function(e,i){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new FirestoreError(e_.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new DatabaseId(e.options.projectId,i)}(l,s),l);return o=Object.assign({useFetchStreams:e},o),h._setSettings(o),h},"PUBLIC").setMultipleInstances(!0)),(0,ee.KN)(eu,"4.7.5",void 0),(0,ee.KN)(eu,"4.7.5","esm2017")}()}},function(e){var __webpack_exec__=function(i){return e(e.s=i)};e.O(0,[774,179],function(){return __webpack_exec__(6840),__webpack_exec__(9974)}),_N_E=e.O()}]);